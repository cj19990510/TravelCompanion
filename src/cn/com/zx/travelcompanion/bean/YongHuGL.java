...
public class YongHuGL {
	...
	public String toString() {
		return "YongHuGL [hotelName=" + hotelName + ", orderId=" + orderId + ", userId=" + userId + ", hotelId="
				+ hotelId + ", roomId=" + roomId + ", dayNum=" + dayNum + ", orderMoney=" + orderMoney + ", orderTime="
				+ orderTime + ", orderState=" + orderState + ", inTime=" + inTime + "]";
	}
